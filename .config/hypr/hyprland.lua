...
-- Fix Dolphin file association blinding
...
hl.config({
    general = {
        ...
        col              = {
            active_border   = { colors = { "0xffb7bdf8", "0xff7dc4e4" }, angle = 45 },
...
hl.bind("CTRL + apostrophe",
    hl.dsp.exec_cmd(
        [[sh -c 'grim -g "$(slurp)" - | satty -f - --copy-command "wl-copy" --early-exit --output-filename "$HOME/Pictures/Screenshots/%Y%m%d_%H%M%S.png"']]))
--------------------------------
...
-- Hide Waybar when an app goes fullscreen
hl.layer_rule({
